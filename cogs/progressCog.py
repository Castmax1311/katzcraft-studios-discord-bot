...
class ProgressCog(commands.Cog):
    ...
    async def progress(self, ctx):
        embed = discord.Embed(title="Progress of the KatzcraftStudios Bots", description="", color=0xff8800)
        embed.add_field(name="Add normal commands:", value="60%", inline=False)
        embed.add_field(name="Add moderation commands:", value="60%", inline=False)
        embed.add_field(name="Profile:", value="15%", inline=False)
